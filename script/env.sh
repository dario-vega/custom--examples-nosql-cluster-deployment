...
export KVHOME=/dba/oracleNoSQL/nosql/kv-24.1.17

export KVROOT=/dba/oracleNoSQL/nosql/kvroot
export PROXYHOME=/dba/oracleNoSQL/proxy

export KVHOST=`hostname`
export KVSTORE=OUG
export PROXYPORT=8080
export PROXYPORTSEC=8443
